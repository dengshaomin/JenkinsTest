            ...
            steps {
                script{
                    try{
                        ...
                        echo "size${size}"
                        try{
                        app_size = size.round(size*100)/100
                        echo "app_size:${app_size}"
                        }catch(Exception e){
                            echo "${e.message}"
                        }
                        try{
                                                size = size.round(size*100)/100
                                                echo "size:${size}"
                                                }catch(Exception e){
                                                    echo "${e.message}"
                                                }
...
//                                                                                         <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 19.2px;"><em><strong>PE-Android-${app_version}</strong></em></p>
//                                                                                     </div>
//                                                                                 </div>
//                                                                             </td>
//                                                                         </tr>
